...
% will assume that if any split datagrams existed, they have already been
% recombined
...
% need to get or set start and end datagram numbers

% setup to pull in water column data
% count datagrams
Ndgm=endDgm-startDgm;
% creat empty arrays to fill
...
for idgm=startDgm:endDgm  % just do the first ping for now
    % set ping counter (assumes that startDgm could be larger than 1)
    pingidx = idgm-startDgm+1; 
...
% will want to save output somewhere
